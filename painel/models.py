...
class Pessoa(models.Model):
    ...
    def limpar_opcoes_associadas_para_alvara(self):
        ...
        # Revoga as frentes de trabalho ativas
    ...
    def save(self, *args, **kwargs):
            # Remover acentos do nome completo antes de salvar
            if self.nome_completo:
                self.nome_completo = unidecode(self.nome_completo)  # Remover acentos
            ...
            # Salva novamente após aplicar as mudanças
            super().save(*args, **kwargs)
...
class FrenteDeTrabalho(models.Model):
    ...
    def save(self, *args, **kwargs):
        numero_inicial = 25  # Número que deseja começar
